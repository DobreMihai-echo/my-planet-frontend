...
@Component({
  selector: 'app-carbot-footprint-offset',
  templateUrl: './carbot-footprint-offset.component.html',
  styleUrls: ['./carbot-footprint-offset.component.css']
})
export class CarbotFootprintOffsetComponent {
  offset: number = 0;
  led: number = 0;
  ledYears: number = 0;
