...
import { ReplyResponse } from 'src/app/models/comment.interface';
  ...
  @Output() updatedCommentCountEvent = new EventEmitter<number>();
	...
	createNewComment(commentInput: HTMLInputElement): void {
		...
		this.subscriptions.push(
			this.markerService.createEventComment(this.data, commentInput.value, this.authService.getUsername()).subscribe(
